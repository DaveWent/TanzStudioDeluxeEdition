 ...
 * @author Christian
 */
public class VRegistroUsuario extends javax.swing.JFrame implements ICierraVentana{
    ...
    private void initComponents() {
        ...
        etRegistrarUsuario.setBounds(140, 10, 186, 22);

        etUsuario.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        etUsuario.setText("Usuario:");
        etUsuario.setPreferredSize(new java.awt.Dimension(438, 325));
        getContentPane().add(etUsuario);
        etUsuario.setBounds(110, 50, 60, 20);
        ...
        txUsuario.setBounds(160, 40, 152, 30);
        ...
        txContraseña.setBounds(160, 80, 152, 30);
        getContentPane().add(txContraseñaConfirmacion);
        txContraseñaConfirmacion.setBounds(160, 120, 152, 30);
        ...
        btAceptar.setBounds(220, 250, 80, 30);
        ...
        cbPregunta.setBounds(160, 160, 230, 30);
        ...
        txRespuesta.setBounds(160, 200, 230, 30);
    ...
    private void btAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAceptarActionPerformed
        CVistaUsuario control = new CVistaUsuario( this );
        try {
            control.altas(txUsuario.getText(), 
                    txContraseña.getText(), 
                    txContraseñaConfirmacion.getText(), 
                    (String)cbPregunta.getSelectedItem(), 
                    txRespuesta.getText(),"administrador","segundaVez");
        } catch (Exception ex) {
            Logger.getLogger(VRegistroUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
